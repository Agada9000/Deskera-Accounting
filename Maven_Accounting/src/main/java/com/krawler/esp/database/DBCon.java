...
public class DBCon {
    ...
    public static String getDashboardData(HttpServletRequest request) throws ServiceException {
        String data = "";
        Session session = null;
        try {
            session = HibernateUtil.getCurrentSession();
            data = DashboardHandler.getDashboardData(session, request);
        } catch (ServiceException ex) {
            Logger.getLogger(DBCon.class.getName()).log(Level.SEVERE, null, ex);
            throw ex;
        } catch (HibernateException ex) {
    ...
    public static JSONObject getVendorDetails(HttpServletRequest request) throws ServiceException, JSONException, SessionExpiredException {
        JSONObject obj = new JSONObject();
        Session session = null;
        try {
            session = HibernateUtil.getCurrentSession();
            obj = ProfileHandler.getVendorDetails(session, request);
        } catch (ServiceException ex) {
            Logger.getLogger(DBCon.class.getName()).log(Level.SEVERE, null, ex);
            throw ex;
        } catch (HibernateException ex) {
    ...
    public static String saveVendorTaxID(HttpServletRequest request) throws ServiceException {
        Session session = null;
        String msg="";
        Transaction tx = null;
        try {
            ...
            msg=ProfileHandler.saveVendorTaxID(session, request);
            tx.commit();
        } catch (ServiceException ex) {
            if (tx != null) {
                tx.rollback();
    ...
    public static JSONObject getFeatureList(HttpServletRequest request) throws ServiceException {
        ...
        try {
            session = HibernateUtil.getCurrentSession();
            jObj = PermissionHandler.getFeatureList(session);
        } catch (ServiceException ex) {
            Logger.getLogger(DBCon.class.getName()).log(Level.SEVERE, null, ex);
            throw ex;
        } catch (HibernateException ex) {
    ...
    public static JSONObject getActivityList(HttpServletRequest request) throws ServiceException {
        ...
        try {
            session = HibernateUtil.getCurrentSession();
            jObj = PermissionHandler.getActivityList(session);
        } catch (ServiceException ex) {
            Logger.getLogger(DBCon.class.getName()).log(Level.SEVERE, null, ex);
            throw ex;
        } catch (HibernateException ex) {
    ...
    public static JSONObject getAllUserDetails(HttpServletRequest request) throws ServiceException {
        JSONObject jObj = new JSONObject();
        Session session = null;
        try {
            session = HibernateUtil.getCurrentSession();
            jObj = ProfileHandler.getAllUserDetails(session, request);
        } catch (ServiceException ex) {
            Logger.getLogger(DBCon.class.getName()).log(Level.SEVERE, null, ex);
            throw ex;
        } catch (HibernateException ex) {
    ...
    public static void saveUser(HttpServletRequest request, HashMap hm) throws ServiceException, AccountingException {
        Session session = null;
        Transaction tx = null;
        try {
            session = HibernateUtil.getCurrentSession();
            tx = session.beginTransaction();
            ProfileHandler.saveUser(session, request, hm);
            tx.commit();
    ...
    public static void deleteUser(HttpServletRequest request) throws ServiceException, AccountingException {
        Session session = null;
        Transaction tx = null;
        try {
            session = HibernateUtil.getCurrentSession();
    ...
    public static JSONObject setPassword(String platformURL,HttpServletRequest request) throws ServiceException {
        Session session = null;
        Transaction tx = null;
        JSONObject jobj=new JSONObject();
        try {
...
//    }
    ...
    public static void saveRole(HttpServletRequest request) throws ServiceException {
        Session session = null;
        Transaction tx = null;
        try {
            session = HibernateUtil.getCurrentSession();
    ...
    public static void deleteRole(HttpServletRequest request) throws ServiceException, AccountingException {
        Session session = null;
        Transaction tx = null;
        try {
            session = HibernateUtil.getCurrentSession();
