    ...
    private static StringBuilder getCompanyAdminDashboardUpdateList(Session session, HttpServletRequest request, JSONObject perms) throws ServiceException {
     ...
     private static StringBuilder getDashBoardDataFlow(Session session, HttpServletRequest request, JSONObject perms) throws ServiceException {
        ...
        try {
            ...
            finalStr.append("<area shape='rect' coords='50,60,150,160' href=# onclick='callVendorDetails(null,true,true)'  wtf:qtip='Maintain all information about your vendors including contact information, account details, preferred delivery mode and payment term. You can also export the vendor list in convenient formats as well as add sub-accounts to existing vendor accounts.'>");
            ...
            finalStr.append("<area shape='rect' coords='182,317,237,382' href=# onclick='callGoodsReceipt(false,null)' wtf:qtip='Provide your vendors with receipt on delivery of purchased goods. Record product and payment details.'> ");
            finalStr.append("<area shape='rect' coords='321,318,394,399' href=# onclick='callDebitNote()' wtf:qtip='Generate a debit note for your vendors for reducing your account payables in cases, such as return of damaged goods, error in billing etc.'>");
            ...
            finalStr.append("<area shape='rect' coords='321,318,394,399' href=# onclick='callCreditNote()' wtf:qtip='If you need to refund your customers on a credit basis i.e. in the near future, generate a credit note for the transaction. Customers can use this credit memo to get a refund in future purchases.'>");
            ...
            finalStr.append("<area shape='rect' coords='293,461,389,534' href=# onclick='callFrequentLedger(true,\"\",\"Cash Book\",\"accountingbase cashbook\")' wtf:qtip='Monitor all cash transactions entered into the system for any time duration.'>");
        ...
        return finalStr;
            ...
            finalStr.append("<area shape='rect' coords='162,541,267,632' href=# onclick='callFrequentLedger(true,\"\",\"Cash Book\",\"accountingbase cashbook\")' wtf:qtip='Monitor all cash transactions entered into the system for any time duration.'>");
...
////            if(PermissionHandler.isPermitted(perms, "bankbook", "view"))
    ...
    public static ArrayList getProductsBelowROLInfo(Session session, String companyID, JSONObject perms,Boolean isDashboard) throws ServiceException {
        ...
        try {
            ...
            for(int i=0;i<jArr.length();i++){
                ...
                if(obj.getInt("quantity")>obj.getInt("reorderlevel")) continue;
    ...
    public static ArrayList getVendorsUpdationInfo(Session session, String companyID, JSONObject perms, Boolean isDashboard) throws ServiceException {
        ArrayList jArray=new ArrayList();
        try {
    ...
    public static ArrayList getCustomersUpdationInfo(Session session, String companyID, JSONObject perms,Boolean isDashboard) throws ServiceException {
        ArrayList jArray=new ArrayList();
        try {
