...
//            groupField : 'product',
        ...
        this.itemlistCm = new Wtf.grid.ColumnModel([
            new Wtf.grid.RowNumberer(),
            {
                ...
                header: WtfGlobal.getLocaleText("acc.cc.3"),  //"Current Quantity",
...
//                editor: this.statuscmbdrop,
        ...
        this.gridwrapper = new Wtf.Panel({
            ...
            items:this.itemlistGrid = new Wtf.grid.EditorGridPanel({
                ...
                view: this.grpView,
                clicksToEdit: 1,
                tbar:[this.RefreshButt,this.UpdateButt]
...
//             if((diffQoH*100/selectedRow.get('curqoh'))>selectedRow.get('tolerancepercent')){
//                selectedRow.set('message','1');
//            }else{
//                selectedRow.set('message','0');
//            }
        }, this);
...
//                    } else {
                      ...
                      WtfComMsgBox([WtfGlobal.getLocaleText("acc.common.success"), WtfGlobal.getLocaleText("acc.cc.23")],0);
...
//        this.edititem.disable();
    ...
    getJsonFromRecord : function(record) {
        ...
        '", "initQua":"' + record.data.currentQuantity +
