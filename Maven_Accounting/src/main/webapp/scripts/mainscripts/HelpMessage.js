...
Wtf.HelpMessages = {
     creditNote:{
        title:'Record a Payment from a customer in response to an invoice.',
    ...
    addAcc:{
        title:'Adding an Account or Subaccount',
        subTitle:'Steps to follow',
        numbered:true,
        width:600,
        height:400,
    ...
    editAcc:{
        title:'Editing an Account or Subaccount',
        subTitle:'Steps to follow',
        numbered:true,
        width:600,
        height:400,
    ...
    deleteAcc:{
        title:'Deleting an Account or Subaccount',
        subTitle:'Steps to follow',
        numbered:true,
        width:600,
        height:400,
    ...
    custTransNumber:{
        title:'Customer or Automatic Transaction Numbers.',
        numbered:false,
        width:600,
        height:400,
        data:[
    ...
    addProduct:{title:'Add New Products.',
        numbered:true,
        subTitle:'Steps to follow',
        width:600,
        height:400,
    ...
    editProduct:{title:'Edit Products.',
        numbered:true,
        subTitle:'Steps to follow',
        width:600,
        height:400,
    ...
    vendorDetails:{title:'Vendors Details.',
        numbered:false,
        width:600,
        height:400,
        data:[
    ...
    addVendor:{title:'Add New Vendor or SubVendor.',
        numbered:true,
        subTitle:'Steps to follow',
        width:600,
        height:400,
    ...
    editVendor:{title:'Edit Customer or SubCustomer.',
        numbered:true,
        subTitle:'Steps to follow',
        width:600,
        height:400,
     ...
     deleteVendor:{title:'Delete Customer or SubCustomer.',
        numbered:true,
        subTitle:'Steps to follow',
        width:600,
        height:400,
    ...
    customerDetails:{title:'Customers List.',
        numbered:false,
        width:600,
        height:400,
        data:[
    ...
    addCustomer:{title:'Add New Customer or SubCustomer.',
        numbered:true,
        subTitle:'Steps to follow',
        width:600,
        height:400,
    ...
    editCustomer:{title:'Edit Customer or SubCustomer.',
        numbered:true,
        subTitle:'Steps to follow',
        width:600,
        height:400,
    ...
    deleteCustomer:{title:'Delete Customer or SubCustomer.',
        numbered:true,
        subTitle:'Steps to follow',
        width:600,
        height:400,
    ...
    masterConfig:{title:'Master Configuration.',
        numbered:false,
        width:600,
        height:400,
        data:[
    ...
    editMasterGroup:{title:'Edit Master Group.',
        numbered:true,
        subTitle:'Steps to follow',
        width:600,
        height:400,
    ...
    addMasterItem:{title:'Add New Master Item.',
        numbered:true,
        subTitle:'Steps to follow',
        width:600,
        height:400,
    ...
    editMasterItem:{title:'Edit Master Item.',
        numbered:true,
        subTitle:'Steps to follow',
        width:600,
        height:400,
     ...
     deleteMasterItem:{title:'Delete Master Item.',
        numbered:true,
        subTitle:'Steps to follow',
        width:600,
        height:400,
    ...
    journalEntryReport:{title:'Jiurnal Entry Report.',
        numbered:true,
        subTitle:'Steps to follow',
        width:600,
        height:400,
