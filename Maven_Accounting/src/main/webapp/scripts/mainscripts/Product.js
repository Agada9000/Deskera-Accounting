   ...
   onRender: function(config){
       Wtf.account.ProductWindow.superclass.onRender.call(this, config);
         ...
         this.add({
            ...
            html: getTopHtml('Product',(this.isEdit?"Edit":"Add New")+' Product',"../../images/accounting_image/add-Product.gif")
        }, {
            region: 'center',
            border: false,
...
//            url: Wtf.req.account+'CompanyManager.jsp',
    ...
    createFields:function(){
        ...
        this.salesReturnAcc=new Wtf.form.FnComboBox({
            fieldLabel:'Sales Return Account*',
            store:this.salesAccStore,
       ...
       this.purchaseReturnAcc=new Wtf.form.FnComboBox({
            fieldLabel:'Purchase Return Account*',
            store:this.purchaseAccStore,
    ...
    checkParent:function(){
        ...
        WtfComMsgBox(["Alert","No Parent Product exist"],1);
    },
    closeForm:function(){        
...
//                        url: Wtf.req.account+'CompanyManager.jsp',
              ...
              if(this.initialprice.getValue()==0){
                WtfComMsgBox(["Alert"," Initial price of the product can not be zero."],2);
                return;
            }

           Wtf.MessageBox.confirm("Save Data"," You cannot edit the initial quantity of the product later. Are you sure you want to continue?",function(btn){
                if(btn!="yes") { return; }
