...
Wtf.importMenuButtonA = function(menuArray,obj,modName) {
    var tbarArchive=new Wtf.Toolbar.Button({
        ...
        id:(modName=="Customer"?"importCustomer6":"importVendor7"),
        tooltip: {
            text: modName=="Customer"? WtfGlobal.getLocaleText("acc.rem.53"):WtfGlobal.getLocaleText("acc.rem.54")///"Import "+modName+" details"
        },
        scope: obj,
...
//            editable : false,
        ...
        this.add({
                    ...
                    border : false,
                    bodyStyle : 'background:white;border-bottom:1px solid #bfbfbf;',
                    html: getImportTopHtml((this.typeXLSFile?WtfGlobal.getLocaleText("acc.import.xls"):WtfGlobal.getLocaleText("acc.import.csv")), "<ul style='list-style-type:disc;padding-left:15px;'><li>"+(this.typeXLSFile?WtfGlobal.getLocaleText("acc.rem.142"):WtfGlobal.getLocaleText("acc.rem.143"))+"</li><li><b>Note</b>: "+WtfGlobal.getLocaleText("acc.rem.92")+"</li></ul>","../../images/import.png", true, "5px 0px 0px 0px", "7px 0px 0px 10px")
                });
        ...
        if(!this.browseField.disabled){
            ...
            if(patt1.test(extension)) {
                ...
                this.ImportForm.form.submit({
                    url:"ImportRecords/importRecords.do?type="+this.moduleName+"&do=getMapCSV&delimiterType="+delimiterType,
...
Wtf.extend(Wtf.SheetViewer1,Wtf.Window,{
    ...
    onRender:function(config){
        ...
        this.add({
            ...
            border : false,
            bodyStyle : 'background:white;border-bottom:1px solid #bfbfbf;',
            html: getImportTopHtml(WtfGlobal.getLocaleText("acc.import.availSheets"), WtfGlobal.getLocaleText("acc.import.step1")+"<br/> "+WtfGlobal.getLocaleText("acc.import.step1"),"../../images/import.png",true, "0px", "7px 0px 0px 10px")
        });
        this.add({
            region:'center',
            layout:'fit',
