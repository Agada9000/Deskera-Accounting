        ...
        if(columnConfig.has("validatetype")) {
           ...
           if(validatetype.equalsIgnoreCase("integer")) {
               ...
               if(!StringUtil.isNullOrEmpty(data)) {
                    ldf = dateFormat!=null ? dateFormat : (data.length()>10 ? df_full : df);
                    try {
                    ...
                    for(int cellcount=0; cellcount<maxCol; cellcount++){
                        ...
                        if(cell!=null){
                            switch(cell.getCellType()){
                                case HSSFCell.CELL_TYPE_NUMERIC: val=Double.toString(cell.getNumericCellValue());
                                                                 ...
                                                                 break;
                                case HSSFCell.CELL_TYPE_STRING: val=cell.getRichStringCellValue().getString(); break;
                            }
                        }
