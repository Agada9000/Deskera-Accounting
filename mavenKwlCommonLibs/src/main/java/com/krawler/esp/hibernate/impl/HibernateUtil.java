...
//			DbPool.closeStatement(stmt);
    ...
    public static int executeUpdate(HibernateTemplate hibernateTemplate, String sql)
			throws ServiceException {
		return executeUpdate(hibernateTemplate, sql, null);
	}

    public static int executeUpdate(HibernateTemplate hibernateTemplate, String hql, Object param)
			throws ServiceException {
		Object[] params = { param };
		return executeUpdate(hibernateTemplate, hql, params);
	}
    ...
    public static Object setterMethod(HibernateTemplate hibernateTemplate, HashMap<String,Object> requestParams, String classstr, String primarykey) throws ServiceException {
        Object obj = null;
        try {
            ...
            throw ServiceException.FAILURE("setterMethod : "+e.getMessage(), e);
        }finally{
            return obj;
        }
    }
