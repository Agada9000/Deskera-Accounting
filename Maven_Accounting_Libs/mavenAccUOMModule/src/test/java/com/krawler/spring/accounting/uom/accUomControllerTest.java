 ...
 * @author krawler
 */
public class accUomControllerTest extends AbstractTransactionalDataSourceSpringContextTests {
    ...
    private static String uomId_update = "c340667e2824756701282579a3f60209"; // Change this id from the DB
    private static String uomId_delete = "c340667e2824756701282579a3f60208"; // Change this id from the DB
    ...
    public accUomControllerTest(String testName) {
        super(testName);
    }
    ...
    /**
     * Test of getUnitOfMeasure method, of class accUomController.
     */
    public void testGetUnitOfMeasure() {
        try {
            ...
            accUomController instance = new accUomController();
            instance.setaccUomDAO(accUomObj);
            instance.setauditTrailDAO(auditTrailObj);
            instance.setSuccessView("jsonView");
            ModelAndView result = instance.getUnitOfMeasure(request, response);
    ...
    /**
     * Test of saveUnitOfMeasure method, of class accUomController.
     * incomplete test case function please set data and deletedata parameters for request and then re-commit the code
     */
    public void testSaveUnitOfMeasure_add() throws JSONException {
        System.out.println("saveUnitOfMeasure");
        try {
            MockHttpServletRequest request = new MockHttpServletRequest();
            MockHttpSession session = createUserMockSession(new JSONObject(sessionParams));
            String data = "[{uomid:\"\",uomname:\"test-data11\",precision:0,uomtype:\"test-unit\",modified:true}]";
            String deleteddata = "[]";
            ...
            ModelAndView result = instance.saveUnitOfMeasure(request, response);
            JSONObject job = new JSONObject(result.getModel().get("model").toString());
...
//            transactionManager.commit(transactionStatus);
    ...
    public void testSaveUnitOfMeasure_edit() throws JSONException {
        System.out.println("saveUnitOfMeasure");
        try {
            MockHttpServletRequest request = new MockHttpServletRequest();
            MockHttpSession session = createUserMockSession(new JSONObject(sessionParams));
            String data = "[{uomid:\""+uomId_update+"\",uomname:\"Pcs1\",precision:1,uomtype:\"Piece1\",modified:true}]";
            String deleteddata = "[]";
            request.setParameter("data", data);
            request.setParameter("deleteddata", deleteddata);
...
//            transactionManager.commit(transactionStatus);
    ...
    public void testSaveUnitOfMeasure_delete() throws JSONException {
        System.out.println("saveUnitOfMeasure");
        try {
            MockHttpServletRequest request = new MockHttpServletRequest();
            MockHttpSession session = createUserMockSession(new JSONObject(sessionParams));
            String data = "[]";
            String deleteddata = "[{uomid:'"+uomId_delete+"',uomname:'Das',precision:0,uomtype:'Unit1',modified:false}]";
            request.setParameter("data", data);
            request.setParameter("deleteddata", deleteddata);
...
//            transactionManager.commit(transactionStatus);
    ...
    public void testSaveUnitOfMeasure_all() throws JSONException {
        System.out.println("saveUnitOfMeasure");
        try {
            MockHttpServletRequest request = new MockHttpServletRequest();
            MockHttpSession session = createUserMockSession(new JSONObject(sessionParams));
            String data = "[{uomid:\""+uomId_update+"\",uomname:\"Pcs\",precision:1,uomtype:\"Piece\",modified:true},{uomid:\"\",uomname:\"test-data\",precision:0,uomtype:\"test-unit\",modified:true}]";
            String deleteddata = "[{uomid:'"+uomId_delete+"',uomname:'Das',precision:0,uomtype:'Unit1',modified:false}]";
            request.setParameter("data", data);
            request.setParameter("deleteddata", deleteddata);
